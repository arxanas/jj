...
impl WorkspaceCommandHelper {
    ...
    fn finish_transaction(&mut self, ui: &mut Ui, mut tx: Transaction) -> Result<(), CommandError> {
            ...
            || settings.user_email() == UserSettings::user_email_placeholder()
        {
            writeln!(
                ui.warning(),
                r#"Name and email not configured; your commits will be created with the empty identity. To configure, add something like the following to $HOME/.jjconfig.toml:
  user.name = "Some One"
